...
public class MiniMaxSumTest extends IOTest {
    ...
    @Test
    public void case2() {
        List<Integer> integers = List.of(7, 69, 2, 221, 8974);
        miniMaxSum(integers);
    ...
    @Test
    public void case3() {
        List<Integer> integers = List.of(256741038, 623958417, 467905213, 714532089, 938071625);
        miniMaxSum(integers);
    ...
    @Test
    public void case4() {
        List<Integer> integers = List.of(5, 5, 5, 5, 5);
        miniMaxSum(integers);
